                        ...
                        return (
                            <>
                                <div key={book._id}>
                                    ...
                                    <h4>${book.price}</h4>
                                    <button onClick={() => {setSingleBook(book); navigate(`/books/${book.title}`)}}><NavLink>read reviews</NavLink></button>
                                    <button onClick={() => setCart(prev => [...prev, book])}>add to cart</button>
                                </div>
                            </>
                        )
                    })
